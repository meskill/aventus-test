...
mod runtime {
    ...
    /// An oracle price feed pallet for gold.
    #[runtime::pallet_index(6)]
    pub type OraclePriceFeedGold = pallet_oracle_price_feed::Pallet<Runtime>;

    /// An oracle price feed pallet for silver.
    #[runtime::pallet_index(7)]
    pub type OraclePriceFeedSilver = pallet_oracle_price_feed::Pallet<Runtime, Instance1>;
}
...
parameter_types! {
    ...
    pub const OraclePriceFeedApiEndpointGold: &'static str = "http://localhost:3000/updatePrice";
    pub const OraclePriceFeedApiEndpointSilver: &'static str = "http://localhost:3001/updatePrice";
}

// Implement the pallet's Config trait
impl pallet_oracle_price_feed::Config for Runtime {
    type RuntimeEvent = RuntimeEvent;
    type PriceApiEndpoint = OraclePriceFeedApiEndpointGold;
}

impl pallet_oracle_price_feed::Config<Instance1> for Runtime {
    type RuntimeEvent = RuntimeEvent;
